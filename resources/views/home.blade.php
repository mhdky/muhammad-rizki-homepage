...
<head>
    ...
    <meta itemprop="image" content="{{ asset('img/profil-2.png') }}">
    ...
    <meta property="og:image" content="{{ asset('img/profil-2.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('img/profil-2.png') }}">
...
<body class="bg-body" id="home">
    <!-- nav mobile -->
    <div class="nav-mobile bg-opacity-50 backdrop-filter backdrop-blur-lg w-[90%] fixed z-30 bottom-4 left-1/2 -translate-x-1/2 py-3 flex justify-evenly items-center border border-zinc-500 rounded-[20px] md-768:hidden">
        <a href="#about" class="text-white text-sm font-bold hover:text-white-primary cursor-default md-768:cursor-pointer">About</a>
        <span class="bg-[#484e53] w-[1px] h-2"></span>
        <a href="#skills" class="text-white text-sm font-bold hover:text-white-primary cursor-default md-768:cursor-pointer">Skills</a>
        <span class="bg-[#484e53] w-[1px] h-2"></span>
        <a href="#portfolio" class="text-white text-sm font-bold hover:text-white-primary cursor-default md-768:cursor-pointer">Portfolio</a>
        <span class="bg-[#484e53] w-[1px] h-2"></span>
        <a href="#contact" class="text-white text-sm font-bold hover:text-white-primary cursor-default md-768:cursor-pointer">Contact</a>
    </div>

    <!-- nav desktop -->
    <div class="nav-desktop hidden w-full md-768:flex justify-center fixed z-30 top-0 duration-700">
        <div class="mt-7 flex">
            <!-- profile -->
            <a href="#home" class="">
                <img src="{{ asset('img/profil-1.png') }}" alt="Muhammad Rizki" class="profil w-[50px] h-max mr-3 cursor-pointer rounded-full">
            </a>

            <!-- list nav -->
            <div class="listNavDesktop bg-opacity-50 backdrop-filter backdrop-blur-md border border-zinc-500 w-[405px] h-12 flex justify-evenly items-center rounded-[20px] ">
                <a href="#about" class="listNav text-white hover:text-white-primary">About</a>
                <a href="#skills" class="listNav text-white hover:text-white-primary">Skills</a>
                <a href="#portfolio" class="listNav text-white hover:text-white-primary">Portfolio</a>
                <a href="#contact" class="listNav text-white hover:text-white-primary">Contact</a>
            </div>
        </div>
    </div>

    <!-- about -->
    <div class="section w-full flex flex-col pt-4 md-768:flex-row md-768:pt-[150px] lg-1000:w-[1000px] lg-1000:mx-auto" id="about">
        ...
        <div class="flex flex-col justify-center md-768:order-2 md-768:w-[40%] md-768:mx-5 md-768:justify-start md-768:items-center md-768:relative lg-1080:mr-0 lg-1080:w-[35%]">
            ...
            <div class="px-3 md-768:bg-black-follow md-768:w-full md-768:absolute md-768:top-[20vw] md-768:rounded-[20px] md-768:px-[4vw] md-768:pb-[4vw] lg-1000:top-[200px] lg-1000:px-[35px] lg-1000:pb-[35px]">
                ...
                <a href="{{ $medsos->linkedin }}"
                    class="flex items-center mt-3 cursor-default md-768:cursor-pointer">
                    <i class="fa-brands fa-linkedin-in"></i>
                    <p class="text-sm font-bold ml-3">LinkedIn</p>
                </a>

                <!-- github -->
                <a href="{{ $medsos->github }}" class="flex items-center mt-3 cursor-default md-768:cursor-pointer">
                    <i class="fa-brands fa-github"></i>
                    <p class="text-sm font-bold ml-3">Github</p>
                </a>

                <!-- email -->
                <a href="{{ $medsos->email }}" class="flex items-center mt-3 cursor-default md-768:cursor-pointer">
        ...
        <div class="mt-3 px-3 md-768:order-1 md-768:mt-0 md-768:w-[60%] md-768:px-5 lg-1080:pl-0">
            <h1 class="text-[#262628] text-[50px] font-bold md-768:text-[96px] md-768:-mt-10">ABOUT</h1>
    ...
    <!-- skills -->
    <div class="section pt-10 px-3 md-768:px-5 lg-1000:w-[1000px] lg-1000:mx-auto lg-1080:pl-0" id="skills">
        <h1 class="text-[#262628] text-[50px] font-bold md-768:text-[96px]">SKILLS</h1>
        ...
        <section>
            ...
            <!-- database orm -->
            <div class="flex items-center mt-7">
                <h2 class="w-[150px] text-[18px] mr-2 font-bold">Database & ORM</h2>
                <div class="bg-white-primary flex-[2] w-full h-[1px]"></div>
            </div>
    ...
    <!-- portfolio -->
    <div class="section pt-10 px-3 md-768:px-5 lg-1000:w-[1000px] lg-1000:mx-auto lg-1080:px-0" id="portfolio">
        <h1 class="text-[#262628] text-[50px] font-bold md-768:text-[96px]">PORTFOLIO</h1>
    ...
    {{-- contact --}}
    <div class="section w-full pt-10 px-3 md-768:mx-auto md-768:px-5 lg-1000:w-[1000px] lg-1080:px-0" id="contact">
        <h1 class="text-[#262628] text-[50px] font-bold md-768:text-[96px]">CONTACT</h1>
        ...
        <form action="/contact" method="POST" autocomplete="off" class="w-full mt-3">
            ...
            <div class="mb-7">
                ...
                @error('name')
                    <input type="text" name="name" maxlength="30" value="{{ old('name') }}" required oninput="messageCheck()" class="inputName bg-black-follow w-full h-[45px] mt-3 rounded-[20px] px-5 focus:outline-none focus:bg-black-nav border border-red-700 focus:border-transparent">
                @else
                    <input type="text" name="name" maxlength="30" required value="{{ old('name') }}" oninput="messageCheck()" class="inputName bg-black-follow w-full h-[45px] mt-3 rounded-[20px] px-5 focus:outline-none focus:bg-black-nav">
                @enderror
            </div>
            ...
            <div class="mb-7">
                ...
                @error('email')
                    <input type="email" name="email" maxlength="50" value="{{ old('email') }}" required onkeyup="messageCheck()" class="inputEmail bg-black-follow w-full h-[45px] mt-3 rounded-[20px] px-5 focus:outline-none focus:bg-black-nav border border-red-700 focus:border-transparent">
                @else
                    <input type="email" name="email" maxlength="50" value="{{ old('email') }}" required onkeyup="messageCheck()" class="inputEmail bg-black-follow w-full h-[45px] mt-3 rounded-[20px] px-5 focus:outline-none focus:bg-black-nav">
                @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                @error('message')
                    <textarea name="message" maxlength="1000" required oninput="messageCheck()" class="inputMessage message bg-black-follow w-full h-[200px] mt-3 rounded-[20px] p-5 resize-none focus:outline-none focus:bg-black-nav border border-red-700 focus:border-transparent">{{ old('message') }}</textarea>
                @else
                    <textarea name="message" maxlength="1000" required oninput="messageCheck()" class="inputMessage message bg-black-follow w-full h-[200px] mt-3 rounded-[20px] p-5 resize-none focus:outline-none focus:bg-black-nav">{{ old('message') }}</textarea>
                @enderror
            </div>
    ...
    @if(session()->has('berhasil'))
        <div class="contact-message fixed z-50 top-0 right-0 bottom-0 left-0 flex justify-center items-end cursor-default md-768:justify-start">
            <p class="the-message bg-white-primary w-[90%] text-black-about text-center font-bold mb-4 py-3 px-4 rounded-[20px] shadow-lg shadow-black md-768:mb-4 md-768:w-max md-768:ml-4">{{ session('berhasil') }}</p>
        </div>
    @endif
    ...
    @if($errors->all())
        <div class="contact-message fixed z-50 top-0 right-0 bottom-0 left-0 flex justify-center items-end cursor-default md-768:justify-start">
            <p class="the-message bg-red-700 font-bold mb-3 ml-3 py-3 px-4 rounded-[20px] shadow-lg shadow-black md-768:mb-4">Gagal terkirim, cek form!</p>
        </div>
    @endif

    <!-- contact and footer -->
    <div class="bg-black-about w-full mt-20 pb-[60px] px-3 flex justify-center md-768:pb-0 md-768:mt-32">
        <div class="flex flex-col">
            <ul class="w-full flex flex-wrap justify-center mt-6 mb-3">
                <li class="mx-2 text-sm text-black-list font-bold hover:text-white-primary md-768:text-base"><a href="{{ $medsos->instagram }}" class="cursor-default md-768:cursor-pointer">Instagram</a></li>
                <li class="mx-2 text-sm text-black-list font-bold hover:text-white-primary md-768:text-base"><a href="{{ $medsos->linkedin }}" class="cursor-default md-768:cursor-pointer">LinkedIn</a></li>
                <li class="mx-2 text-sm text-black-list font-bold hover:text-white-primary md-768:text-base"><a href="{{ $medsos->github }}" class="cursor-default md-768:cursor-pointer">Github</a></li>
                <li class="mx-2 text-sm text-black-list font-bold hover:text-white-primary md-768:text-base"><a href="{{ $medsos->email }}" class="cursor-default md-768:cursor-pointer">E-Mail</a></li>
            </ul>
